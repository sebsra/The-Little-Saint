...
func _on_elias_portal_entered(body):
	print("Elias")
...
func _on_sebastian_portal_entered(body):
	mode = "normal"
	get_tree().change_scene_to_file("res://Stages/Sebastians_Stage/level_1.tscn")
	save_settings() # Replace with function body.

func _on_prince_portal_entered(body):
	get_tree().change_scene_to_file("res://Stages/Prince_Stage/game_prince.tscn")
	save_settings()
...
func _on_fallzone_body_entered(body):
	get_tree().change_scene_to_file("res://Stages/Ardits_Stage/Arrogance.tscn")

func _on_life_up_body_entered(body):
	get_parent().get_node("HUD").change_life(0.25)

func _on_life_down_body_entered(body):
		get_parent().get_node("HUD").change_life(-0.25)
...
func _on_test_portal_body_entered(body):
	get_tree().change_scene_to_file("res://Stages/AdventureLevel.tscn")
